...
public class PeopleView {
    ...
    public static class Person {
        ...
        @XmlElement(nillable = true)
        protected List<PeopleView.Person.HealthProfile> healthProfile;
         ...
         * 
         */
        public List<PeopleView.Person.HealthProfile> getHealthProfile() {
            if (healthProfile == null) {
                healthProfile = new ArrayList<PeopleView.Person.HealthProfile>();
            }
